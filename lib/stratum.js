...
var StratumClient = function(options){
    ...
    function handleSubscribe(message){
        ...
        _this.emit('subscription',
            ...
            function(error, extraNonce1, extraNonce2Size){
                ...
                let result = options.coin.isProgPow ? [
                    null,
                    extraNonce1
                ] : 
                [
    ...
    function handleSubmit(message){
        ...
        } else if (options.coin.isProgPow) {
            params.nonce = message.params[2].substr(2);
            params.header = message.params[3].substr(2);
            params.mixhash = message.params[4].substr(2);
        } else {
