...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    function SetupRecipients(){
        ...
        for (var r in options.rewardRecipients){
            ...
            if (options.coin.isZCashProtocol || options.coin.isKawPow) {
                var rObj = {
                    percent: percent,
                    address: r
                };
    ...
    function SetupJobManager(){
        ...
        _this.jobManager.on('newBlock', function(blockTemplate){
            ...
            if (_this.stratumServer) {
                ...
                job[options.coin.isKawPow ? 4 : 8] = false;
    ...
    **/
    this.processBlockNotify = function(blockHash, sourceTrigger) {
        ...
        if (typeof(_this.jobManager.currentJob) !== 'undefined' && typeof(_this.jobManager.currentJob) !== 'undefined' && typeof(_this.jobManager.currentJob.rpcData.previousblockhash) !== 'undefined' && blockHash !== _this.jobManager.currentJob.rpcData.previousblockhash){
            GetBlockTemplate(function(error, result){
                if (error)
